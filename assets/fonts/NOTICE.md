...
## Current site face: Redaction 35

Redaction 35 Regular, Copyright 2019 MCKL Inc., downloaded from
https://www.redaction.us/static/redaction.zip. Used under its SIL Open Font
License 1.1 option; the supplied notice is in `Redaction-OFL.txt`.
`Redaction_35-Regular.woff2` is unmodified and self-hosted. The other font
files below are historical assets, no longer used by the main public pages
or browser instrument interfaces.
